$(document).ready(function() {
    ...
    $("#rregisterCamp").click(function(e){
        ...
        console.log({ firstname, lastname, phone, email, ageGroup, gender, kidsComing, kidsNumber, member, district, arrivalDate, houseAccess, anyAmount, userId, campId });
        ...
        if(firstname === ""){
            ...
            key: 'pk_live_b3e5d1863418258bc93d723b28364de61e043bc1', // Replace with your public key
    ...
    $("#pregisterCamp").click(function(e){
        ...
        console.log({ firstname, lastname, phone, email, ageGroup, gender, kidsComing, kidsNumber, member, district, arrivalDate, houseAccess, premiumAmount, userId, campId });
