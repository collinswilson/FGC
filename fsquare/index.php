        ...
        <div class="tab-pane fade in show active p-3" id="panel555" role="tabpanel">
            ...
            <?php
                ...
                <div id="regularDiv">
                    ...
                    <button type="button" class="btn btn-rounded btn-danger" id="rregisterCampAnonymous"><i class="far fa-plus-square pr-2" aria-hidden="true"></i> Register Now</button>
                    </div>
                ...
                <div id="premiumDiv" style="display: none">
                    ...
                    <button type="button" class="btn btn-rounded btn-danger" id="pregisterCampAnonymous"><i class="far fa-plus-square pr-2" aria-hidden="true"></i></i>Register Now</button>
                    </div>
