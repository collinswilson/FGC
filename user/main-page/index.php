                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            ...
                            <div id="regularDiv">
                                ...
                                <div id="userEmail" style="display: none">'.$email.'</div>
                        ...
                        <!--Bulk table-->
                        <div class="col-md-8 col-lg-8 col-sm-12 p-3">
                            <div class="float-right mb-5">
                                <h4 class="grey-text">Total : &#8358;<span id="total" class="text-success">0</span></h4>
                            </div>
                            <table class="table table-border table-hover" style="display: block; overflow: auto; overflow: scroll; white-space: nowrap;">
                                <thead>
                                    <tr>
                                    <th scope="col">#</th>
                            ...
                            <div class="mt-5 text-center">
                                <button class="btn btn-danger btn-rounded" id="bulkRegisterLoader" type="button" style="display: none">
                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                        Loading...
                                </button>
