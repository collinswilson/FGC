...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark black">
      ...
      <button class="navbar-toggler btn-danger" type="button" data-toggle="collapse" data-target="#navbarSupportedContent-555"
        ...
        <ul class="navbar-nav ml-auto nav-flex-icons">
          <li class="nav-item avatar dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-55" data-toggle="dropdown"
              ...
              <div class="border border-danger text-center d-flex justify-content-center align-items-center" style="border-radius: 100px; padding:5px; width: 30px; height: 30px; background-color: black;">
                  <span class="text-danger" style="font-size: 12px;"><?php echo $firstnameFirst." ".$lastnameFirst?></span>
              </div>
            </a>
    ...
    <div style="width: 90%; margin: auto;">
        ...
        <ul class="nav nav-tabs md-tabs nav-justified danger-color" role="tablist">
            ...
            <a class="nav-link active black-text" data-toggle="tab" href="#panel555" role="tab">
                <i class="fas fa-plus"></i><br/>Register</a>
            </li>
            ...
            <div class="tab-pane fade in show active p-3" id="panel555" role="tabpanel">
                ...
                <?php
                    ...
                    <div id="regularDiv">
                        ...
                        <div class="form-group">
                            <label class="grey-text">Coming with kids? <span class="text-danger">*</span></label>
                            <select class="browser-default custom-select" id="rkidsComing">
                        ...
                        <div class="form-group" id="rkidsNum">
                            <label class="grey-text">How many kids?</label>
                            <select class="browser-default custom-select" id="rkidsNumber">
                                <option value="" selected>Choose answer</option>
                                <option value="1-3 Kids">1-3 Kids</option>
                                <option value="4-7 Kids">4-7 Kids</option>
                                <option value="Above 7 Kids">Above 7 Kids</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="grey-text">Arival Day <span class="text-danger">*</span></label>
                            <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                                <input placeholder="Select date" type="date" id="rarrivalDate" class="form-control">
                                <label for="example">Arival Date...</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="grey-text">Do you have access to a house in camp? <span class="text-danger">*</span></label>
                            <select class="browser-default custom-select" id="rhouseAccess">
                                <option value="" selected>Choose answer</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <button type="button" class="btn btn-rounded btn-danger" id="rregisterCamp"><i class="far fa-plus-square pr-2" aria-hidden="true"></i> Register Now</button>
                        </div>
                    ...
                    <div id="premiumDiv" style="display: none">
                        ...
                        <div class="form-group">
                            <label class="grey-text">Coming with kids? <span class="text-danger">*</span></label>
                            <select class="browser-default custom-select" id="pkidsComing">
                                <option value="" selected>Choose answer</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="form-group" id="pkidsNum">
                            <label class="grey-text">How many kids?</label>
                            <select class="browser-default custom-select" id="pkidsNumber">
                                <option value="" selected>Choose answer</option>
                                <option value="1-3 Kids">1-3 Kids</option>
                                <option value="4-7 Kids">4-7 Kids</option>
                                <option value="Above 7 Kids">Above 7 Kids</option>
                        ...
                        <div class="form-group">
                            <label class="grey-text">Arival Day <span class="text-danger">*</span></label>
                            <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                                <input placeholder="Select date" type="date" id="parrivalDate" class="form-control">
                                <label for="example">Arival Date...</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="grey-text">Do you have access to a house in camp? <span class="text-danger">*</span></label>
                            <select class="browser-default custom-select" id="phouseAccess">
                                <option value="" selected>Choose answer</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <button type="button" class="btn btn-rounded btn-danger" id="pregisterCamp"><i class="far fa-plus-square pr-2" aria-hidden="true"></i></i>Register Now</button>
                        </div>
    ...
    <footer style="position: absolute; bottom: 0; height: 60px; width: 100%;">
    ...
    aria-hidden="true">
        ...
        <div class="modal-dialog modal-md" role="document">
            ...
            <div class="modal-content" style="height: 500px">
                ...
                <div class="modal-footer">
                    <!--button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button-->
                    <button type="button" class="btn btn-danger btn-sm" id="okReg">Ok</button>
                </div>
            </div>
        </div>
    </div>
