        ...
        <div class="tab-pane fade in show active p-3" id="panel555" role="tabpanel">
            ...
            <?php
                ...
                <div id="premiumDiv" style="display: none">
                    ...
                    <button type="button" class="btn btn-rounded btn-danger" onclick="pregisterCampAnonymous()" id=""><i class="far fa-plus-square pr-2" aria-hidden="true"></i></i>Register Now</button>
                    </div>
    ...
    aria-hidden="true">
        ...
        <div class="modal-dialog modal-md" role="document">
            ...
            <div class="modal-content" style="height: 500px">
                ...
                <div class="modal-footer">
                    <!--button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button-->
                    <button type="button" class="btn btn-danger btn-sm" id="okRegAnonymous" onclick="payedin">Ok</button>
                </div>
            </div>
        </div>
    </div>
