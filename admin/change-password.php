                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="p-5 d-flex justify-content-center align-items-center">
                            <input type="password" class="form-control form-control-user" id="password" placeholder="New Password">
                            <input type="password" class="form-control form-control-user" id="rpassword" placeholder="Repeat New Password">
                            <a id="changePword" class="btn btn-primary btn-user btn-block w-50">Change password now</a>
                        </div>
                        <div class="mt-5 text-center" style="display: none" id="scanLoader">
